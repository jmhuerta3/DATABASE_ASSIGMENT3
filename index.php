...
<body style="background-color: #f0f8ff;"> <!-- Light blue background -->
  <div style="margin-top: 20px" class="container">
    ...
    <div class="button-group">
      ...
      <br><br>
      <button class="btn btn-secondary" onclick="location.href='login_opportunities.php'">
        View Opportunities
      </button>
      <br><br>
      <button class="btn btn-success" onclick="location.href='login_representative.php'">
